...
class Lesson2 {
    ...
    static int formula(int x) {
        double y;
        y = Math.floor(Math.sqrt(13*x + 13/x));
        return (int) y;
    }
    ...
    static String initials(String fullName) {
        ...
        String shortName = partName[0].charAt(0) + "." + partName[1].charAt(0) + "." + partName[2].charAt(0) + ".";
        //shortName.toUpperCase(); // эта строка почему-то не отрабатывает
